...
<?php include 'includes/admin_navigation.php'; ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $subscriber_count = mysqli_num_rows($select_subscribers_query);
                      ...
                      function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                          ...
                          <?php 
                            ...
                            $element_text = ['All Posts', 'Active Posts', 'Draft Posts', 'Comments', 'Unapproved Comments', 'Users', 'Subcribers', 'Categories'];
